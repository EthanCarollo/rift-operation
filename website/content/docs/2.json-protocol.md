...
"dream_rift_part_count": int | null
"nightmare_rift_part_count": int | null
```
...
> Se lance quand `dream_rift_part_count` + `nightmare_rift_part_count` == 2
...
> Se lance quand `dream_rift_part_count` + `nightmare_rift_part_count` == 4
...
> Se lance quand `dream_rift_part_count` + `nightmare_rift_part_count` == 6
