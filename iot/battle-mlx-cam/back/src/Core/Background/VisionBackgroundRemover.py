import time
from src.Framework.Background.AbstractBackgroundRemover import AbstractBackgroundRemover

class VisionBackgroundRemover(AbstractBackgroundRemover):
    """
    Background removal using macOS Vision framework (native).
    Fallback to rembg if Vision fails or is unavailable.
    """
