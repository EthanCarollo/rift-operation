#!/usr/bin/env python3
"""
Benchmark script for Pruna AI Flux Kontext Fast via Replicate API.
"""
import os
import time
import base64
...
def main():
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "benchmark_pruna_output.jpg")
    
    model_slug = "prunaai/flux-kontext-fast"
    ...
    # STEP 1: Image to bytes / Data URI
    ...
    print(f"\n{Colors.BOLD}Starting benchmark for {model_slug}...{Colors.ENDC}")
    print(f"{Colors.WARNING}Prompt: {prompt}{Colors.ENDC}")
    
    # STEP 2: Request to Replicate
