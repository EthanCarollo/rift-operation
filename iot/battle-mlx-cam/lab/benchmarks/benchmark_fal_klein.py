#!/usr/bin/env python3
"""
Benchmark script for Klein 4b Edit via FAL API.
"""
import os
import time
import sys
...
def main():
    ...
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "benchmark_output.png")
    ...
    print(f"Starting benchmark for Klein 4b Edit...")
    print(f"Prompt: {prompt}")
    
    try:
        start_time = time.time()
        output_bytes, elapsed = transform_image(image_bytes, prompt)
