...
if __name__ == "__main__":
    ...
    mimi_weights = hf_hub_download(args.hf_repo, lm_config["mimi_name"], local_dir=local_dir)
    moshi_name = lm_config.get("moshi_name", "model.safetensors")
    moshi_weights = hf_hub_download(args.hf_repo, moshi_name, local_dir=local_dir)
    tokenizer = hf_hub_download(args.hf_repo, lm_config["tokenizer_name"], local_dir=local_dir)
